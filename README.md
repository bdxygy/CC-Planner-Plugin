...
└── [feature-topic]/
    ...
    ├── frontend-tasks.md (generated by /task-fe)
    ├── frontend-tasks.json (generated by /task-fe)
    ├── backend-tasks.md (generated by /task-be)
    └── backend-tasks.json (generated by /task-be)
```
